...
namespace ShoppingListMobileApp1
{
    public class ItemDetailPageViewModel : INotifyPropertyChanged
    {
        ...
        public async Task LoadItemDetail(int itemId)
        {
            // Burada itemservice ile ilgili itemı çekip Item özelliğine atayabilirsiniz.
            Item = await itemservice.GetItemsById(itemId);
        }

        // Burada gerekli diğer komutları tanımlayabilirsiniz.
    }
}
